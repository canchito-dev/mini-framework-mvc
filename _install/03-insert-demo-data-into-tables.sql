...
--
INSERT INTO `db_mini`.`songs` (`id`, `artist`, `track`, `link`) VALUES
...
INSERT INTO `users` (`user_id`, `names`, `lastnames`, `email`, `password`, `birthday`, `gender`, `created_timestamp`) VALUES
(1, 'Test Name', 'User Lastname', 'mini.framework.mvc@gmail.com', '$2y$10$iaZJJhQGEuyjDWhNhk3uPeYCO1WaoN1lYVCAmRwfCX1LFO/seJohC', '09/11/2016', 'male', '2016-11-09 21:10:42');